...
@f_app.route('/frizer/<int:frizer_id>/komentar', methods=['POST'])
@login_required
def dodaj_komentar_frizerja(frizer_id):
    return controllers.frizer_controller.dodaj_komentar(frizer_id)
