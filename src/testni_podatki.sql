...
VALUES (1, 1, 1, 1, '2026-05-07', '10:00:00', 'active'),
...
INSERT INTO urnik (id_frizerja, dan, ura) VALUES
    ...
    (1, '2026-05-07', '09:00:00'),
    (1, '2026-05-07', '10:00:00'),
    (1, '2026-05-07', '11:00:00'),
    (1, '2026-05-07', '12:00:00'),
    (1, '2026-05-07', '13:00:00'),
    (1, '2026-05-07', '14:00:00'),
    (1, '2026-05-07', '15:00:00'),
    (1, '2026-05-07', '16:00:00'),
    (1, '2026-05-08', '09:00:00'),
    (1, '2026-05-08', '10:00:00'),
    (1, '2026-05-08', '11:00:00'),
    (1, '2026-05-08', '12:00:00'),
    -- Tina: pon–sre 10:00–17:00
    (2, '2026-05-07', '10:00:00'),
    (2, '2026-05-07', '11:00:00'),
    (2, '2026-05-07', '12:00:00'),
    (2, '2026-05-07', '13:00:00'),
    (2, '2026-05-07', '14:00:00'),
    (2, '2026-05-07', '15:00:00'),
    (2, '2026-05-08', '10:00:00'),
    (2, '2026-05-08', '11:00:00'),
    (2, '2026-05-08', '12:00:00'),
    (2, '2026-05-08', '13:00:00'),
    -- Miha: tor–pet 08:00–15:00
    (3, '2026-05-08', '08:00:00'),
    (3, '2026-05-08', '09:00:00'),
    (3, '2026-05-08', '10:00:00'),
    (3, '2026-05-08', '11:00:00'),
    (3, '2026-05-08', '12:00:00'),
    (3, '2026-05-08', '13:00:00'),
    (3, '2026-05-09', '08:00:00'),
    (3, '2026-05-09', '09:00:00'),
    (3, '2026-05-09', '10:00:00'),
    (3, '2026-05-09', '11:00:00');
