...
INSERT INTO urnik (id_frizerja, dan, ura) VALUES
    ...
    (2, '2026', '10:00:00'), (2, '2026', '11:00:00'),
    (2, '2026', '12:00:00'), (2, '2026', '13:00:00'),
    (2, '2026', '14:00:00'), (2, '2026', '15:00:00'),
    (2, '2026-05-07', '10:00:00'), (2, '2026-05-07', '11:00:00'),
    (2, '2026-05-07', '12:00:00'), (2, '2026-05-07', '13:00:00'),
    -- Miha: tor–pet 08:00–15:00
    (3, '2026-05-07', '08:00:00'), (3, '2026-05-07', '09:00:00'),
    (3, '2026-05-07', '10:00:00'), (3, '2026-05-07', '11:00:00'),
    (3, '2026-05-07', '12:00:00'), (3, '2026-05-07', '13:00:00'),
    (3, '2026-05-07', '08:00:00'), (3, '2026-05-07', '09:00:00'),
    (3, '2026-05-07', '10:00:00'), (3, '2026-05-07', '11:00:00');

INSERT INTO blokiran_termin (id_frizerja, datum, ura_od, ura_do, razlog) VALUES
    (1, '2026-05-07', '12:00:00', '14:00:00', 'Kosilo'),
    (2, '2026-05-07', '09:00:00', '17:00:00', 'Dopust'),
    (3, '2026-05-07', '08:00:00', '10:00:00', 'Sestanek');
ON CONFLICT DO NOTHING;